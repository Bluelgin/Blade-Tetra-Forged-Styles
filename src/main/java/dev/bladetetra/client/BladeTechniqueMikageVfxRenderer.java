...
/** Mikage combat, boundary, torii and encounter render families. */
final class BladeTechniqueMikageVfxRenderer {
    static void drawSolidCore(BufferBuilder buffer, Matrix4f matrix, Vec3 camera,
    ...
    static boolean isSolidCoreType(int type) {
    ...
    static void drawPursuitReturn(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawMirrorDuel(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawSealLink(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawSealBreak(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength) {
    ...
    static void drawSealSuccess(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength) {
        float fade = 1.0F - t;
    ...
    static void drawSealFailure(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawCounterClash(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength) {
        float fade = (1.0F - t) * (1.0F - t);
    ...
    static void drawBoundaryStrike(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawBoundarySuppressionFlame(BufferBuilder buffer,
    ...
    static void drawToriiCage(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawCagePulse(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
        float fade = 1.0F - t;
    ...
    static void drawCageResult(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawBoundaryFlash(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawBoundaryCharge(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawBoundaryFlashRelease(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawBoundaryFlashImpact(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
        float fade = 1.0F - t;
    ...
    static void drawBoundaryWall(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawBoundaryFlameField(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawBoundaryFlameGround(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawBoundaryFlameTongue(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawBoundaryLowFlame(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawTaperedFlameVolume(BufferBuilder buffer, Matrix4f matrix,
    ...
    static Vec3 flameRingOffset(Vec3 axisA, Vec3 axisB,
    ...
    static void drawGapWisp(BufferBuilder buffer, Matrix4f matrix, Vec3 camera,
    ...
    static void drawBoundaryWallBreak(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
        float fade = 1.0F - t;
    ...
    static void drawHaloTorii(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawBoundaryBlade3d(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void orientedBox(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawToriiSweepCore(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawToriiCageCore(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength) {
        float warning = Mth.clamp(effect.age / 25.0F, 0.0F, 1.0F);
        float recovery = Mth.clamp((t - 0.90F) / 0.10F, 0.0F, 1.0F);
    ...
    static void drawBoundaryFlashCore(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float strength, int quality) {
        float reveal = Mth.clamp((effect.age - 12.0F) / 148.0F, 0.0F, 1.0F);
    ...
    static void drawBoundaryFlashReleaseCore(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawBoundaryWallCore(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float strength) {
        drawBoundaryFlameField(buffer, matrix, camera, effect, strength, 1, true);
    }

    static void drawScissorResultCore(BufferBuilder buffer, Matrix4f matrix,
    ...
    static void drawPursuitSwordCore(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength) {
        float fade = 1.0F - t;
    ...
    static void drawToriiSweep(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
        Minecraft minecraft = Minecraft.getInstance();
        boolean personal = minecraft.player != null
                && minecraft.player.getId() == effect.targetEntityId;
    ...
    static double scissorOpenDegrees(int age) {
    ...
    static void drawScissorResult(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int result) {
        float fade = (1.0F - t) * (1.0F - t);
        Vec3 center = effect.start;
        int red = color(1.0F, 0.02F, 0.07F, fade * 0.88F);
    ...
    static void drawPursuitLock(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawPursuitSword(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength) {
        float fade = 1.0F - t;
    ...
    static void drawMoonEchoField(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawMoonEchoResult(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, boolean success) {
        float fade = (1.0F - t) * (1.0F - t);
    ...
    static void drawSwordWheel(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength, int quality) {
    ...
    static void drawSwordWheelBreak(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength) {
        float fade = (1.0F - t) * (1.0F - t);
    ...
    static void drawMirrorFailure(BufferBuilder buffer, Matrix4f matrix,
            Vec3 camera, Effect effect, float t, float strength) {
    ...
    private BladeTechniqueMikageVfxRenderer() {
    }
}
